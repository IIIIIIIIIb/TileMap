var config = [
    ...
    { x: 4, y: 4, walkable: true, image: "true_png" },
    { x: 5, y: 4, walkable: true, image: "true_png" },
    ...
    { x: 4, y: 5, walkable: true, image: "true_png" },
    { x: 5, y: 5, walkable: true, image: "true_png" },
            ...
            if (aStar.findPath(grid)) {
                ...
                if (!move) {
                    for (var i = 0; i < path.length; i++) {
                        ...
                        time = distance / TileMap.PlayerSpeed;
                        console.log("start");
                        this.timer.start();
